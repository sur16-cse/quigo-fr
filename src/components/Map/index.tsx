...
const Map = React.forwardRef(
  ({ pickupCoordinates, dropoffCoordinates }: MapProps, ref): JSX.Element => {
    ...
    const [distance, setDistance] = useState(defaultRiderMapBoxProps.distance);
    const [duration, setDuration] = useState(defaultRiderMapBoxProps.duration);
